...
export default function HealingAndMeditationPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(0);

  const pillars = [
    {
      icon: Compass,
      title: "Guided Mindful Journeying",
      description:
        "Custom meditative journeys designed to quiet mental chatter, ground your awareness, and foster profound inner peace.",
    },
    {
      icon: Heart,
      title: "Chakra & Subtle Body Alignment",
      description:
        "Harmonize energy channels through targeted breathwork and meditative visualization to restore vitality and emotional balance.",
    },
    {
      icon: Wind,
      title: "Pranayama & Somatic Release",
      description:
        "Harness regulated breath mechanics to release somatic stress, soothe the nervous system, and dissolve physical tension.",
    },
    {
      icon: Moon,
      title: "Transcendental Spiritual Awakening",
      description:
        "Connect with higher states of consciousness, tap into your innate intuition, and experience total soul-level renewal.",
    },
  ];
  ...
  const steps = [
    {
      number: "01",
      title: "Intention & Mindset Assessment",
      description:
        "We discuss your current mental state, emotional stressors, and spiritual goals to tailor a personalized healing practice.",
    },
    {
      number: "02",
      title: "Somatic Breath & Grounding",
      description:
        "Beginning with gentle, deep breathwork to regulate the nervous system and anchor your focus into the present moment.",
    },
    {
      number: "03",
      title: "Guided Deep Healing Meditation",
      description:
        "Immerse yourself in high-vibrational guided visualization, clearing blockages across your chakras and subtle bodies.",
    },
    {
      number: "04",
      title: "Integration & Sustained Practice",
      description:
        "Grounding the peaceful awareness into your daily life with actionable meditation techniques and mindfulness habits.",
    },
  ];

  const faqs = [
    {
      question: "What is Healing and Meditation coaching?",
      answer:
        "Healing and Meditation coaching combines guided mindfulness, ancient breathwork practices, and energetic balancing to reduce mental noise, heal emotional stress, and bring your body and mind into complete equilibrium.",
    },
    {
      question: "Do I need previous experience with meditation?",
      answer:
        "Not at all. Sessions are customized for all experience levels, from absolute beginners who struggle to sit still to experienced practitioners looking to deepen their spiritual practice.",
    },
    {
      question: "How does distance or online meditation guidance work?",
      answer:
        "Mindfulness and energy transcendence are not bound by physical distance. Guided sessions held online provide the exact same calming, restorative benefits, allowing you to relax in your personal sacred space.",
    },
    {
      question: "Can these practices help with chronic stress and anxiety?",
      answer:
        "Yes. Regulated breathwork and structured meditation trigger the parasympathetic nervous system, lowering cortisol levels, calming an overactive mind, and providing long-term tools for emotional resilience.",
    },
  ];
  ...
  return (
    <main className="relative min-h-screen bg-[#05030e] text-white selection:bg-[#e5c77b] selection:text-black">
      ...
      <div className="pointer-events-none absolute left-[15%] top-[5%] -z-10 h-[500px] w-[500px] rounded-full bg-teal-950/30 blur-[160px]" />
      ...
      {/* Hero Section                                                               */}
      {/* -------------------------------------------------------------------------- */}
      <section className="relative px-6 pt-24 pb-16 md:px-12 lg:px-16">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
            ...
            >
              ...
              <p className="mt-6 text-base font-light leading-relaxed text-white/80 md:text-lg">
                Return to your center. Discover deep mental clarity, dissolve anxiety, and realign your energy body through personalized guided meditation and holistic somatic healing.
              </p>
            ...
            >
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl border border-white/15 bg-[#0a071d]/80 shadow-[0_0_50px_rgba(0,0,0,0.8)] backdrop-blur-xl">
                <Image
                  src="/images/healandmeditate.jpg"
                  alt="Healing and Guided Meditation Practice"
                  fill
                  priority
                ...
                <div className="absolute bottom-6 left-6 right-6 rounded-2xl border border-white/10 bg-[#0a071d]/80 p-5 backdrop-blur-md">
                  ...
                  <p className="mt-1 text-xs text-white/60">
                    Somatic grounding and high-frequency meditation journeys.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="rounded-3xl border border-white/10 bg-[#0a071d]/60 p-8 backdrop-blur-md md:p-12">
          <div className="max-w-3xl">
            <h2 className="font-serif text-3xl font-medium text-white sm:text-4xl">
              Nurture Inner Serenity & Soul Realignment
            </h2>
            <p className="mt-4 text-base font-light leading-relaxed text-white/70">
              Modern life often pushes our nervous systems into chronic overdrive, causing mental fatigue, emotional overwhelm, and a sense of detachment from our higher purpose. Healing and Meditation sessions offer a peaceful sanctuary to reset.
            </p>
            <p className="mt-4 text-base font-light leading-relaxed text-white/70">
              By blending ancient meditative wisdom, structured breath mechanics, and gentle energy purification, we help you quiet intrusive thoughts, awaken your intuition, and cultivate lasting stillness from within.
            </p>
          </div>

          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              "Soothe chronic stress and quiet anxious thoughts",
              "Master breathwork techniques for instant grounding",
              "Unblock chakra energy for greater vitality",
              "Improve focus, mental clarity, and intuition",
              "Cultivate daily mindfulness and emotional balance",
              "Guided individual & group sessions available",
            ].map((item, i) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="mb-12 text-center">
          <h2 className="font-serif text-3xl font-medium text-white sm:text-4xl">
            Pillars of Healing & Meditation
          </h2>
          <p className="mt-2 text-sm text-white/60">
            A comprehensive approach to mental, physical, and spiritual harmony.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="mb-12 text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            A structured, calming sequence designed to guide you into deep stillness.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:px-12">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            Common questions regarding our healing and meditation practices.
          </p>
        </div>
      ...
      {/* -------------------------------------------------------------------------- */}
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="relative overflow-hidden rounded-3xl border border-[#e5c77b]/30 bg-gradient-to-r from-[#0a071d] via-[#082928] to-[#0a071d] p-10 text-center md:p-16">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm font-light text-white/70 md:text-base">
            Step away from the noise and reconnect with your inner stillness. Book a personalized Healing & Meditation session today.
          </p>
