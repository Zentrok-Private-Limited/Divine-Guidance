...
export default function NlpAstrologyPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(0);

  const pillars = [
    {
      icon: Brain,
      title: "Mindset & Subconscious Rewiring",
      description:
        "Reprogram limiting belief systems and subconscious patterns identified within your astrological natal chart placement.",
    },
    {
      icon: Compass,
      title: "Astrological Timeline Mapping",
      description:
        "Combine planetary Dasha cycles with NLP timeline techniques to navigate major life transitions with confidence.",
    },
    {
      icon: Zap,
      title: "Behavioral Transformation",
      description:
        "Break recurring negative behavioral loops triggered by planetary transits using precise NLP anchoring and reframing.",
    },
    {
      icon: Target,
      title: "Purpose & Goal Alignment",
      description:
        "Align your conscious ambitions with your soul’s true cosmic blueprint (North Node/Rahu) for effortless success.",
    },
  ];
  ...
  const steps = [
    {
      number: "01",
      title: "Astrological Blueprint Assessment",
      description:
        "We map your birth chart to uncover core psychological patterns, strengths, and unconscious mental blocks.",
    },
    {
      number: "02",
      title: "NLP Pattern Identification",
      description:
        "Pinpoint the exact self-sabotaging thoughts, emotional triggers, or language patterns holding you back.",
    },
    {
      number: "03",
      title: "Subconscious Alignment Session",
      description:
        "Apply powerful NLP reframing, timeline shifts, and visualization techniques aligned with your favorable transits.",
    },
    {
      number: "04",
      title: "Sustained Behavioral Shift",
      description:
        "Integrate practical daily mental anchors to lock in confidence, emotional control, and long-term clarity.",
    },
  ];

  const faqs = [
    {
      question: "What is NLP in Astrology?",
      answer:
        "Neuro-Linguistic Programming (NLP) combined with Astrology uses your unique birth chart as a blueprint for your mind. While astrology highlights your subconscious tendencies and timing, NLP provides actionable psychological techniques to reframe those tendencies for personal growth.",
    },
    {
      question: "How does combining NLP with Astrology differ from traditional astrology?",
      answer:
        "Traditional astrology identifies planetary influences and timings, while NLP Astrology goes a step further by giving you concrete cognitive tools and mental exercises to actively change how you react to those planetary energies.",
    },
    {
      question: "Do I need prior knowledge of NLP or Astrology?",
      answer:
        "Not at all. The session is fully guided. We break down complex chart placements and psychological concepts into simple, actionable steps tailored to your personal goals.",
    },
    {
      question: "Can NLP Astro Coaching help with anxiety and decision-making?",
      answer:
        "Yes. By understanding your chart's emotional indicators (such as Moon and Mercury placements) and applying NLP grounding techniques, you can overcome decision paralysis and reduce situational anxiety.",
    },
  ];
  ...
  return (
    <main className="relative min-h-screen bg-[#05030e] text-white selection:bg-[#e5c77b] selection:text-black">
      ...
      <div className="pointer-events-none absolute left-[15%] top-[5%] -z-10 h-[500px] w-[500px] rounded-full bg-indigo-950/25 blur-[160px]" />
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
            ...
            >
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#e5c77b]/30 bg-black/40 px-4 py-1.5 backdrop-blur-md">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#e5c77b]">
                  Cognitive Astro Guidance
                </span>
              </div>

              <h1 className="font-serif text-4xl font-normal tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
                NLP & Mindset Coaching in Astrology
              </h1>

              <p className="mt-6 text-base font-light leading-relaxed text-white/80 md:text-lg">
                Bridge cosmic timing with psychological mastery. Combine ancient planetary wisdom with Neuro-Linguistic Programming to rewire limiting subconscious beliefs, overcome anxiety, and align your life path.
              </p>
            ...
            >
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl border border-white/15 bg-[#0a071d]/80 shadow-[0_0_50px_rgba(0,0,0,0.8)] backdrop-blur-xl">
                <Image
                  src="/images/nlp.jpg"
                  alt="NLP in Astrology and Subconscious Coaching"
                  fill
                  priority
                ...
                <div className="absolute bottom-6 left-6 right-6 rounded-2xl border border-white/10 bg-[#0a071d]/80 p-5 backdrop-blur-md">
                  <p className="font-serif text-lg text-[#e5c77b]">
                    "As within the mind, so expanded in the stars."
                  </p>
                  <p className="mt-1 text-xs text-white/60">
                    Mastering subconscious mindsets through cosmic alignment.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="rounded-3xl border border-white/10 bg-[#0a071d]/60 p-8 backdrop-blur-md md:p-12">
          <div className="max-w-3xl">
            <h2 className="font-serif text-3xl font-medium text-white sm:text-4xl">
              Harmonize Subconscious Mindsets with Celestial Timing
            </h2>
            <p className="mt-4 text-base font-light leading-relaxed text-white/70">
              Astrology reveals the unique landscape of your subconscious blueprint, highlighting where you are naturally gifted and where deeply ingrained conditioning holds you back. Neuro-Linguistic Programming (NLP) provides the psychological tools required to actively reshape those mental pathways.
            </p>
            <p className="mt-4 text-base font-light leading-relaxed text-white/70">
              By combining astrological chart analysis with state-of-the-art NLP techniques, we help you eliminate self-doubt, reframe negative emotional patterns, and step confidently into your highest potential during key planetary phases.
            </p>
          </div>

          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              "Identify & reprogram self-limiting belief loops",
              "Align subconscious intentions with planetary transits",
              "Overcome decision paralysis & mental fatigue",
              "Develop positive emotional anchors for high performance",
              "Reframe personal past narratives and trauma",
              "Unlock true potential using North Node alignment",
            ].map((item, i) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="mb-12 text-center">
          <h2 className="font-serif text-3xl font-medium text-white sm:text-4xl">
            Our NLP Astro Coaching Pillars
          </h2>
          <p className="mt-2 text-sm text-white/60">
            Synthesizing modern cognitive techniques with ancient wisdom.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="mb-12 text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            A structured method to align your mindset with cosmic timing.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:px-12">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            Understanding NLP techniques applied through an astrological lens.
          </p>
        </div>
      ...
      {/* -------------------------------------------------------------------------- */}
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="relative overflow-hidden rounded-3xl border border-[#e5c77b]/30 bg-gradient-to-r from-[#0a071d] via-[#140b2e] to-[#0a071d] p-10 text-center md:p-16">
          ...
          <h2 className="font-serif text-3xl font-normal text-white sm:text-4xl md:text-5xl">
            Master Your Mind & Align Your Stars
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-sm font-light text-white/70 md:text-base">
            Take conscious control of your life. Book an NLP Astrology session to dissolve mental barriers and realize your true potential.
          </p>
