...
export default function BrahmshaktiHealingPage() {
  const [openFaq, setOpenFaq] = useState<number | null>(0);

  const pillars = [
    {
      icon: SunMedium,
      title: "Divine Energy Transmission",
      description:
        "Channel high-vibrational cosmic light directly into your physical and etheric body to restore spiritual harmony.",
    },
    {
      icon: Activity,
      title: "Deep Karmic Cleansing",
      description:
        "Dissolve ancestral karmic debts, past-life blockages, and lingering energetic burdens holding you back.",
    },
    {
      icon: Shield,
      title: "Aura Protection Shield",
      description:
        "Encase your aura in a protective shield of Brahmshakti vibration, guarding against external negativity and psychic attacks.",
    },
    {
      icon: InfinityIcon,
      title: "Holistic Mind-Body Rejuvenation",
      description:
        "Balance your subtle energy channels (Nadiss), boost vitality, and achieve profound emotional equilibrium.",
    },
  ];
  ...
  const steps = [
    {
      number: "01",
      title: "Subtle Energy Scan",
      description:
        "We assess your aura, chakras, and karmic flow to locate severe energy leakages or spiritual blockages.",
    },
    {
      number: "02",
      title: "Brahmshakti Invocation",
      description:
        "Connecting with supreme cosmic consciousness to initiate the powerful flow of divine healing energy.",
    },
    {
      number: "03",
      title: "Deep Cleansing & Realignment",
      description:
        "Systematic removal of dense negative imprints, balancing the subtle channels across all seven chakras.",
    },
    {
      number: "04",
      title: "Energetic Sealing & Protection",
      description:
        "Locking in high-vibrational light to ensure long-lasting spiritual vitality, peace, and protection.",
    },
  ];

  const faqs = [
    {
      question: "What is Brahmshakti Healing?",
      answer:
        "Brahmshakti Healing is a sacred, high-vibrational cosmic energy healing modality that channels divine creative energy (the supreme Brahm force) to cleanse, restore, and align the mental, physical, and spiritual bodies.",
    },
    {
      question: "How does Brahmshakti Healing differ from standard Reiki or energy healing?",
      answer:
        "While standard energy practices focus primarily on chakra balancing, Brahmshakti Healing operates at a deeper karmic and soul level—clearing deeply rooted ancestral patterns, stubborn energetic blockages, and severe spiritual attachments.",
    },
    {
      question: "Can Brahmshakti Healing be performed remotely?",
      answer:
        "Yes. Cosmic Brahmshakti energy transcends space and time. Distance sessions are equally effective, allowing the practitioner to channel healing vibrations to you wherever you are in the world.",
    },
    {
      question: "What will I feel during a session?",
      answer:
        "Sensations vary from person to person. Many clients report feeling deep warmth, gentle tingling, immense emotional relief, lightness, or entering a state of profound meditative tranquility.",
    },
  ];
  ...
  return (
    <main className="relative min-h-screen bg-[#05030e] text-white selection:bg-[#e5c77b] selection:text-black">
      ...
      <div className="pointer-events-none absolute left-[15%] top-[5%] -z-10 h-[500px] w-[500px] rounded-full bg-amber-800/20 blur-[160px]" />
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
            ...
            >
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#e5c77b]/30 bg-black/40 px-4 py-1.5 backdrop-blur-md">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#e5c77b]">
                  Divine Cosmic Healing
                </span>
              </div>

              <h1 className="font-serif text-4xl font-normal tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
                Brahmshakti Healing Services
              </h1>

              <p className="mt-6 text-base font-light leading-relaxed text-white/80 md:text-lg">
                Awaken your highest divine potential. Channel supreme cosmic energy to dissolve ancestral karma, remove persistent spiritual blockages, and experience deep holistic transformation.
              </p>
            ...
            >
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl border border-white/15 bg-[#0a071d]/80 shadow-[0_0_50px_rgba(0,0,0,0.8)] backdrop-blur-xl">
                <Image
                  src="/images/BrahmshaktiHealing.jpg"
                  alt="Brahmshakti Divine Healing and Cosmic Energy Work"
                  fill
                  priority
                ...
                <div className="absolute bottom-6 left-6 right-6 rounded-2xl border border-white/10 bg-[#0a071d]/80 p-5 backdrop-blur-md">
                  <p className="font-serif text-lg text-[#e5c77b]">
                    "Connect with the ultimate source of supreme light."
                  </p>
                  <p className="mt-1 text-xs text-white/60">
                    Karmic purification & high-vibrational spiritual awakening.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="rounded-3xl border border-white/10 bg-[#0a071d]/60 p-8 backdrop-blur-md md:p-12">
          <div className="max-w-3xl">
            <h2 className="font-serif text-3xl font-medium text-white sm:text-4xl">
              Elevate Your Soul with the Power of Brahmshakti
            </h2>
            <p className="mt-4 text-base font-light leading-relaxed text-white/70">
              Brahmshakti represents the supreme, unmanifested creative energy of the universe. When life challenges, karmic imprints, or intense negative energies suppress your inner light, Brahmshakti Healing serves as a divine catalyst to restore order and vitality.
            </p>
            <p className="mt-4 text-base font-light leading-relaxed text-white/70">
              By working beyond the physical and emotional realms, this sacred healing technique purifies your soul level, releasing deep-seated karmic burdens, balancing subtle Nadis, and shielding your aura against future adversity.
            </p>
          </div>

          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              "Clear ancestral & past-life karmic burdens",
              "Purify and strengthen the spiritual aura",
              "Align Nadis & activate deep chakra energy",
              "Shield against negative influences & psychic drains",
              "Accelerate emotional healing & mental clarity",
              "Establish a profound connection to higher consciousness",
            ].map((item, i) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="mb-12 text-center">
          <h2 className="font-serif text-3xl font-medium text-white sm:text-4xl">
            Pillars of Brahmshakti Healing
          </h2>
          <p className="mt-2 text-sm text-white/60">
            Sacred practices designed for total energetic and spiritual restoration.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="mb-12 text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            A sacred four-step process to receive divine energy and karmic relief.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:px-12">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            Answers to common questions about Brahmshakti divine energy sessions.
          </p>
        </div>
      ...
      {/* -------------------------------------------------------------------------- */}
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-12 lg:px-16">
        <div className="relative overflow-hidden rounded-3xl border border-[#e5c77b]/30 bg-gradient-to-r from-[#0a071d] via-[#241305] to-[#0a071d] p-10 text-center md:p-16">
          ...
          <h2 className="font-serif text-3xl font-normal text-white sm:text-4xl md:text-5xl">
            Experience Divine Light & Transformation
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-sm font-light text-white/70 md:text-base">
            Clear your karmic path and invite supreme cosmic energy into your life. Book a confidential Brahmshakti Healing session today.
          </p>
